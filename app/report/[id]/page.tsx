...
export default function ReportDashboardPage() {
  ...
  const verdictTone = ['STRONG HIRE', 'HIRE'].includes(report.verdict) ? 'text-emerald-300 border-emerald-400/40 bg-emerald-400/10' : report.verdict === 'LEAN HIRE' ? 'text-amber-300 border-amber-400/40 bg-amber-400/10' : report.verdict === 'INCONCLUSIVE' ? 'text-sky-200 border-sky-400/40 bg-sky-400/10' : 'text-rose-300 border-rose-400/40 bg-rose-400/10';
