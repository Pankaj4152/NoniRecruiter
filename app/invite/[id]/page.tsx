...
interface CandidateInvite { candidate: { name: string }; job: { companyName: string; roleTitle: string }; targetDurationMinutes: number; status: string; resumeReceived: boolean; topics: string[] }
