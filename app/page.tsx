      ...
      <div className="grid w-full items-center gap-10 lg:grid-cols-[1.05fr_.95fr]">
        ...
        <section className="mission-card setup-overlay p-5 sm:p-7">
          ...
          <div className="mt-5 space-y-3">
            ...
            <div className="border border-white/10 bg-black/25 p-5 opacity-70"><div className="flex items-start gap-4"><span className="grid h-11 w-11 shrink-0 place-items-center border border-white/15 text-[#8d8981]"><Play className="h-5 w-5" /></span><div className="flex-1"><div className="flex items-center gap-2"><h2 className="font-black uppercase text-[#d0ccc4]">Try a sample interview</h2><span className="system-code border border-white/10 px-2 py-1">Coming next</span></div><p className="mt-1 text-xs leading-5 text-[#77736c]">Explore a preconfigured candidate interview in one click.</p></div></div></div>
          </div>
